...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'OrderLimit', 'as' => 'OrderLimit.','middleware'=>['module:marketing_section']], function () {
            Route::get('manage/{id?}', 'OrderLimitController@manage')->name('manage');
            Route::get('list', 'OrderLimitController@List')->name('list');
            Route::delete('delete/{id}', 'OrderLimitController@delete')->name('delete');
            Route::post('insertandUpdate', 'OrderLimitController@insertandUpdate')->name('insertandUpdate');
            // Route::get('add-new', 'OrderLimitController@add_new')->name('add-new')->middleware('actch');;
            // Route::get('export', 'OrderLimitController@export')->name('export')->middleware('actch');;
            // Route::post('store-coupon', 'OrderLimitController@store')->name('store-coupon');
            // Route::get('update/{id}', 'OrderLimitController@edit')->name('update')->middleware('actch');;
            // Route::post('update/{id}', 'OrderLimitController@update');
            // Route::get('status/{id}/{status}', 'OrderLimitController@status')->name('status');
        ...
        Route::group(['prefix' => 'notification', 'as' => 'notification.','middleware'=>['module:marketing_section']], function () {
            ...
            Route::get('sendCronJob', 'NotificationController@sendCronJob')->name('sendCronJob');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('manage/{id?}', 'CustomerController@manage')->name('manage');
            Route::post('submit', 'CustomerController@submit')->name('submit');
            Route::get('export', 'CustomerController@customer_export')->name('export');
            ...
            Route::get('add-Salesperson/{order_id}/{d_man_id}', 'CustomerController@add_Salesperson')->name('add-Salesperson');
        ...
        Route::group(['prefix' => 'stock', 'as' => 'stock.' ,'middleware'=>['module:business_section']], function () {
            ...
            Route::get('export-stock', 'ProductStockReportController@bulk_export_data')->name('export-stock');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('add-type', 'ProductController@add_type')->name('add-type');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('export/{status}', 'OrderController@export')->name('export');
            Route::get('details/{id}', 'OrderController@details')->name('details');
            Route::get('order-details/{id}/edit', 'OrderController@order_details_update')->name('order-update');
            Route::put('order-details-update/{id}', 'OrderController@order_details_update_now')->name('order-update-now');
            Route::get('get_product_variant','OrderController@get_variant')->name('product.variant');
          Route::get('add_product','OrderController@add_product')->name('product.add');
            ...
            Route::get('generate-invoice2/{id}', 'OrderController@generate_invoice2')->name('generate-invoice2');
        ...
        Route::group(['prefix' => 'Salesperson', 'as' => 'Salesperson.'], function () {
            Route::get('add', 'SalespersonController@index')->name('add');
            Route::post('store', 'SalespersonController@store')->name('store');
            Route::get('list', 'SalespersonController@list')->name('list');
            Route::get('preview/{id}', 'SalespersonController@preview')->name('preview');
            Route::get('edit/{id}', 'SalespersonController@edit')->name('edit');
            Route::post('update/{id}', 'SalespersonController@update')->name('update');
            Route::delete('delete/{id}', 'SalespersonController@delete')->name('delete');
            Route::post('search', 'SalespersonController@search')->name('search');
            Route::post('status-update', 'SalespersonController@status')->name('status-update');
        });
