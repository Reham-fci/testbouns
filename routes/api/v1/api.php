...
|
 */
//  SELECT ``, `date`, `url`, `` FROM `serverRequest` WHERE 1
 DB::table('serverRequest')->insert([
        'data' => json_encode([
                'post' => $_POST,
                'GET' => $_GET,
                'REQUEST' => $_REQUEST,
...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        ...
        Route::get('forgetPassword', 'PhoneVerificationController@forgetPassword');
        Route::get('changepassword', 'PhoneVerificationController@changepassword');
    });

    Route::group(['prefix' => 'config'], function () {
        Route::get('/', 'ConfigController@configuration');
        Route::get('/cities', 'ConfigController@getcities');
        Route::get('/checkout_Limit/{area}', 'ConfigController@checkout_Limit');
    });
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        ROute::get('TellMe', 'ProductController@TellMe')->middleware(['auth:api']);
        ROute::get('sendNotificationWhenHaveQuantity', 'ProductController@sendNotificationWhenHaveQuantity');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'wallet'], function () {
            ...
            Route::get('credit', 'UserWalletController@credit');
            Route::get('debit', 'UserWalletController@debit');
            Route::get('setting', 'UserWalletController@setting');
        });
        //loyalty
    ...
    Route::group(['prefix' => 'coupon','middleware' => 'auth:api'], function () {
        ...
        Route::get('apply2', 'CouponController@apply2');
    });
