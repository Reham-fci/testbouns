        ...
        <div
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                ...
                <div class="row" style="padding-bottom: 20px">
                    ...
                    <!---->
                    <div class="col-md-6">
                        @php($bonus_facebook=\App\Model\BusinessSetting::where('type','bonus_facebook')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('bonus_facebook')}}</label>
                            <input class="form-control" type="text" name="bonus_facebook"
                                   value="{{ $bonus_facebook->value?$bonus_facebook->value:"" }}"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        @php($bonus_telegram=\App\Model\BusinessSetting::where('type','bonus_telegram')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('bonus_telegram')}}</label>
                            <input class="form-control" type="text" name="bonus_telegram"
                                   value="{{ $bonus_facebook->value?$bonus_telegram->value:"" }}"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        @php($bonus_WhatsApp=\App\Model\BusinessSetting::where('type','bonus_WhatsApp')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('bonus_WhatsApp')}}</label>
                            <input class="form-control" type="text" name="bonus_WhatsApp"
                                   value="{{ $bonus_WhatsApp->value?$bonus_WhatsApp->value:"" }}"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        @php($bonus_phone=\App\Model\BusinessSetting::where('type','bonus_phone')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('bonus_phone')}}</label>
                            <input class="form-control" type="text" name="bonus_phone"
                                   value="{{ $bonus_phone->value?$bonus_phone->value:"" }}"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        @php($bonus_google_play=\App\Model\BusinessSetting::where('type','bonus_google_play')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('bonus_google_play')}}</label>
                            <input class="form-control" type="text" name="bonus_google_play"
                                   value="{{ $bonus_google_play->value?$bonus_google_play->value:"" }}"
                                   placeholder="">
                        </div>
                    </div>
                    <!---->
