...
class SMS_module
{
    ...
    public static function send($receiver, $otp){
        ...
        CURLOPT_URL => 'https://verify.twilio.com/v2/Services/VAa5fdd84d832084457bcf72cdf2eaf09c/Verifications',
        ...
        CURLOPT_POSTFIELDS => 'To=%2B2'.$receiver.'&Channel=sms',
        CURLOPT_HTTPHEADER => array(
        'Authorization: Basic QUNiZTE5MjUxYTI5ZThlZTFlOWI2YjNhZTg4ZmZkZDNhYjphYjAyZDUzMjJiYTA4YWNlNjljN2JmMDMxZTNhYzQyYw==',
    ...
    public static function verifyPhoneNumber($code , $phone ){
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://verify.twilio.com/v2/Services/VAa5fdd84d832084457bcf72cdf2eaf09c/VerificationCheck',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => 'POST',
        CURLOPT_POSTFIELDS => 'To=%2B2'.$phone.'&Code='.$code,
        CURLOPT_HTTPHEADER => array(
            'Authorization: Basic QUNiZTE5MjUxYTI5ZThlZTFlOWI2YjNhZTg4ZmZkZDNhYjphYjAyZDUzMjJiYTA4YWNlNjljN2JmMDMxZTNhYzQyYw==',
            'Content-Type: application/x-www-form-urlencoded'
        ),
    ...
    // public $key = "AIzaSyAnme6TYLGGwBO241sWVoiTFKPdq_tecjk";
    public static function send_firebase($receiver, $otp){
        $key = "AIzaSyBz25Pv4Oh71L7nDkklzXalNkO7QAYScRk";
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/sendVerificationCode?key='.$key,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public static function verifyPhoneNumberFirebase($code, $sessionInfo){
        $key = "AIzaSyBz25Pv4Oh71L7nDkklzXalNkO7QAYScRk";
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPhoneNumber?key='.$key,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public static function send_old($receiver, $otp)
    {
