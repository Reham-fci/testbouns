...
class BusinessSettingsController extends Controller
{
    ...
    public function updateInfo(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'bonus_google_play'], [
            'value' => $request['bonus_google_play']
        ]);
        DB::table('business_settings')->updateOrInsert(['type' => 'bonus_telegram'], [
            'value' => $request['bonus_telegram']
        ]);
        DB::table('business_settings')->updateOrInsert(['type' => 'bonus_phone'], [
            'value' => $request['bonus_phone']
        ]);
        DB::table('business_settings')->updateOrInsert(['type' => 'bonus_WhatsApp'], [
            'value' => $request['bonus_WhatsApp']
        ]);
        DB::table('business_settings')->updateOrInsert(['type' => 'bonus_facebook'], [
            'value' => $request['bonus_facebook']
        ]);
