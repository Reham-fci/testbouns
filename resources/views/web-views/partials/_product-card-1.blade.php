@if(isset($product))
    ...
    <!--<div class="flash_deal_product rtl" style="border:#0000000d 1px solid;cursor: pointer; height:180px;{{Session::get('direction') === "rtl" ? 'margin-right:6px;' : 'margin-left:6px;'}}"-->
