    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.Salesperson.update',[$delivery_man['id']])}}" method="post"
                            ...
                            <div class="row">
                                ...
                                @foreach(json_decode($delivery_man['identity_image'],true) as $img)
                                    <div class="col-md-4 col-12 mb-2">
                                        <img height="150" src="{{asset('storage/app/public/Salesperson').'/'.$img}}">
                                    </div>
                                @endforeach
                                <hr>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <center>
                                    <img style="height: 200px;border: 1px solid; border-radius: 10px;" id="viewer"
                                         src="{{asset('storage/app/public/Salesperson').'/'.$delivery_man['image']}}" alt="delivery-man image"/>
                                </center>
                            </div>
                            <hr>
