                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        @else
                            <button class="btn btn-xs btn-warning"><i
                                    class="tio-map"></i> {{translate('no_location_found')}}</button>
                        @endif
                    </div>
        ...
        <div class="row" id="printableArea">
                            ...
                            <div class="col-6 pt-2">
                                <div class="flex-end">
                                    <h6 class="text-capitalize"
                                        style="color: #8a8a8a;">{{translate('payment_method')}} :</h6>
                                    <h6 class="mx-1"
            ...
            <div class="col-lg-4">
                    ...
                    @if($order->customer)
                        ...
                        <div class="card-body"
                            ...
                            <div class="media align-items-center" href="javascript:">
                                ...
                                <div class="media-body">
                                    <span
                                        class="text-body text-hover-primary"> {{\App\Model\Order::where('customer_id',$order['customer_id'])->count()}} {{translate('orders')}}</span>
                                </div>
                                <div class="media-body text-right">
                ...
                @else
                    <div class="card-body"
                    style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            <span>{{translate('Customer_not_found')}}</span>
                    </div>
                @endif
                <!-- End Body -->
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"
                        id="locationModalLabel">{{translate('location')}} {{translate('data')}}</h4>
