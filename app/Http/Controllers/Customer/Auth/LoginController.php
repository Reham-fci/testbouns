...
class LoginController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        $user = User::where(['phone' => $request->user_id])->orWhere(['phone' => "+20".$request->user_id])->orWhere(['phone' => "20".$request->user_id])->orWhere(['email' => $request->user_id])->first();
        ...
        if (isset($user) && $user->is_active && auth('customer')->attempt(['phone' => $user->phone, 'password' => $request->password], $remember)) {
