            ...
            @if($detail->product)
                ...
                <tr>
                    ...
                    <td class="">
                        ...
                        {{translate('Discount')}} : {{\App\CPU\Helpers::currency_converter(round($detail['discount'],2))}}
                    </td>
                    <td style="width: 28%">
