...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('reset-password2', 'ForgotPasswordController@reset_password2')->name('reset-password2');
        ...
        Route::post('otp-verification2', 'ForgotPasswordController@otp_verification_submit2')->name('otp-verification2');
        Route::post('reset_password-ajax', 'ForgotPasswordController@reset_password_ajax')->name('reset_password-ajax');
        Route::get('reset-password', 'ForgotPasswordController@reset_password_index')->name('reset-password');
        Route::post('reset-password', 'ForgotPasswordController@reset_password_submit')->name('reset-password');
        Route::post('change-password2', 'ForgotPasswordController@reset_password_submit2')->name('change-password2');
    });
