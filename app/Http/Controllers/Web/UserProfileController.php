...
class UserProfileController extends Controller
{
    ...
    public function account_address()
    {
        ...
        if (auth('customer')->check()) {
            ...
            return view('web-views.users-profile.account-address', compact('shippingAddresses' ,'governorates'  , 'cities' ));
        } else {
            return redirect()->route('home');
        }
    }
    ...
    {   
        ...
        {
            return view('web-views.users-profile.account-address-edit',compact('shippingAddress','governorates','cities'));
        }else{
