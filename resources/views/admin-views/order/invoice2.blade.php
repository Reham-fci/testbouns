            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <div class="h4 montserrat-normal-600">
                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->customer !=null? $order->customer['f_name'].' '.$order->customer['l_name']:translate('name_not_found')}}</p>
                        ...
                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->shippingAddress ? str_replace("\u{202C}", '' ,$order->shippingAddress['address']) : ""}} </p>
                ...
                @if ($order->billingAddress)
                    <td valign="top">
                        ...
                        <div class="h4 montserrat-normal-600">
                            ...
                            <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->billingAddress ? str_replace("\u{202C}", '' ,$order->billingAddress['address']) : ""}}</p>
...
<div class="row" >
    <div class=" content-height content-position-y" style="">
        <h2>{{translate('order_note')}}: {{$order['order_note']}}</h2>
    </div>
</div>
        ...
        <tr>
            ...
            <th style="text-align: right;width:70%;">
                <table style="width: 96%;margin-left:41%; display: inline " class="text-right sm-padding strong bs-0">
                    ...
                    <tr>
                        <th class="gry-color text-left"><b>{{translate('wallet_discount')}}</b></th>
                        <td>
                            - {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->walletAmount))}} </td>
                    </tr>
                    @if ($order->order_type=='POS')
                        <tr>
                            <th class="gry-color text-left"><b>{{translate('extra_discount')}}</b></th>
                            <td>
                    ...
                    <tr class="bg-primary" style="background-color: #2D7BFF">
                        ...
                        <td class="text-white">
                            ...
                            {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total+$shipping-$total_discount_on_product-$coupon_discount-$walletAmount))}}
                        </td>
                    </tr>
                    </tbody>
                </table>
