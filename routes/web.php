...
use App\Http\Controllers\ProductScript ;
...
Route::get('ProductScript/run', 'ProductScript@run');
...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        Route::post('checkout-Limit', 'WebController@checkout_Limit')->name('checkout-Limit');
    ...
    Route::get('categories/{id?}', 'WebController@all_categories')->name('categories');
    ...
    Route::get('wallet/remove_expired_fund_from_wallet','UserWalletController@remove_expired_fund_from_wallet');
...
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'namespace' => 'Web'], function () {
    ...
    Route::get('removeAllCarts', 'CartController@removeAllCarts');
});
...
Route::get('sendCronJob', [NotificationController::class, 'sendCronJob']);
