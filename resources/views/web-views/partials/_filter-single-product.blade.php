...
<div class="product-single-hover" style="">
    ...
    @if($product->current_stock <= 0)
        <span style="position: absolute;z-index: 99999999999999;background: rgb(255 0 0 / 100%);text-align: center;color: #000;font-weight: bolder;top: 8px;left: 8px;width: 150px;">{{\App\CPU\translate('not_available')}}</span>
    @endif
