                        ...
                        <form action="{{route('admin.notification.store')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-6">
                                    <label>{{\App\CPU\translate('date_notify')}}</label>
                                    <input type="datetime-local" name="date_notify" value="<?=date('Y-m-d H:i:s')?>"  id="from_date"
                                            class="form-control" >
                                </div>
                                <div class="col-md-3 col-6">
                    ...
                    <div class="table-responsive datatable-custom">
                        <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            <tr>
                                ...
                                <th style="width: 40%">{{\App\CPU\translate('date')}} </th>
