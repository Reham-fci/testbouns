                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-select form-control select-areas" name="city" type="country" id="si-area"
                                        ...
                                        @foreach ($cities as $city)
                                            <option {{$shippingAddress->city == $city->id ? "selected" : ""}} class="city-non-active {{$shippingAddress->zip == $city->governorate_id ? "city-active" : ""}}" data-parent="{{$city->governorate_id}}" value="{{$city->id}}">{{$city->city_name_ar}}</option>
                                        @endforeach
                                    </select>
                                    {{--  --}}
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-select form-control select-areas" name="zip" type="zip" id="si-city"
                                        ...
                                        @foreach ($governorates as $governorate)
                                            <option {{$shippingAddress->zip == $governorate->id ? "selected" : ""}} value="{{$governorate->id}}">{{$governorate->governorate_name_ar}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on('ready', function () {
        <?php
            $shippingAddress->latitude = $shippingAddress->latitude  ? $shippingAddress->latitude :  "-33.8688";
            $shippingAddress->longitude = $shippingAddress->longitude  ? $shippingAddress->longitude : "151.2195";
        ?>
        initAutocomplete(<?=$shippingAddress->latitude?> , <?=$shippingAddress->longitude?>);
