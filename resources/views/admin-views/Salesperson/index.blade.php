                    ...
                    <div class="card-header">
                        <div class="align-items-center">
                            <div class="col-sm mb-2 mb-sm-0">
                                <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{\App\CPU\translate('add')}} {{\App\CPU\translate('new')}} {{\App\CPU\translate('Salesperson')}}</h1>
                            </div>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    <div class="card-body">
                        <form action="{{route('admin.Salesperson.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label>{{\App\CPU\translate('Salesperson')}} {{\App\CPU\translate('image')}}</label><small style="color: red">* ( {{\App\CPU\translate('ratio')}} 1:1 )</small>
