...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{translate('Shipping Method Update')}}</li>
        </ol>
    </nav>
                        ...
                        <div class="form-group">
                            <div class="row ">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="duration" value="{{$method['duration']}}" class="form-control" placeholder="{{translate('Ex')}} : {{translate('4 to 6 days')}}">
                                </div>
                            </div>
                        </div>
